...
places <- data.frame(
  ...
  popup = c(
    "José Banegas Gil. Nacido: 1900.",
    "Isabel Rubio Redondo. Nacida: 1908."
  )
)
...
En 1927 José aparece en una lista en la Gaceta de Madrid de doctores que han aprobado el examen para ingresarse al Cuerpo de Inspectores Municipales de Sanidad[@1927_doctor].
...
En el mismo mes, el Boletín Official de Ceuta anuncia que José fue emplazado por la Comisíon de Incautación de Bienes de la Plaza de Ceuta por su "oposición y actividades contrarias al Glorioso Movimiento Nacional"[@1939_boletin].
...
Map: Archena - Larache, Tanger -\> casablanca?

## Escapando a Mexico

Desafortunadamente, no hay un record publicado sobre lo que pasó entre 1939 y 1941.

Sin embargo, los nombres de José, Isabel, y sus tres hijos aparecen en una lista de pasajeros de barcos que llegaron a San Juan, Puerto Rico en el 18 de febrero en 1941. Habían viajado por un barco de vapor que había salido de La Guaira, Venezuela. El record dice que la ultima residencia de la familia fue Santos, Brazil[@PR_passengerlist].

```{r}

knitr::include_graphics("images/SanJuan_PR.png")
```

En el 9 de marzo 1941, la familiia entraron a Mexico por la puerta de Veracruz en un barco de vapor que se llamaba Monterrey que había salido de Santos, Brasil.
...
Aqui son los documentos para entrar Mexico[@JBG_immig_doc][@IRR_immig_doc]. El documento dice que su primera lugar residencia fue 211 Amsterdam en la Ciudad de Mexico.
...
As his whereabouts were still unknown to the Spanish government, José's name would continue to appear in the newspaper in Spain.
